...
domain = {'North'  : ['鞍部', '淡水'  , '竹子湖', '基隆'  , '台北', '新屋'  , '板橋'  , 
                      '新竹', '宜蘭'  , '蘇澳'],
          'Central': ['梧棲', '台中'  , '日月潭', '阿里山', '嘉義', '玉山'],
          'South'  : ['嘉義', '玉山'  , '永康'  , '台南'  , '高雄', '大武'  , '恆春'],
          'YunChia': ['台中', '日月潭', '阿里山', '嘉義'  , '玉山', '永康'  , '台南'],
          'East'   : ['台中', '花蓮'  , '日月潭', '阿里山', '玉山', '成功'  , '台東'  , '大武'],
          'Taiwan' : ['鞍部', '淡水'  , '竹子湖', '基隆'  , '台北', '新屋'  , '板橋'  , '新竹', 
